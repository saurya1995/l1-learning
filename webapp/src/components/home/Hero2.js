        ...
        <div className="pt-24">
            <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <p className="uppercase tracking-loose w-full text-white">Get started today</p>
                    <h1 className="my-4 text-5xl font-bold leading-tight text-white">
                        Welcome to L1 Analytics!
                    </h1>
                    <p className="leading-normal text-2xl mb-8 text-white">
                        Learn more about your team's performance and well-being with machine learning based insights
                    </p>
                    {state.isSignedIn ?
                        <Link
                            to={"/insights"}
                ...
                <div className="w-full md:w-3/5 py-6 text-center">
                    <img alt={"Hero"} className="w-full md:w-4/5 z-50" src={heroImage}/>
                </div>
            </div>
        </div>
